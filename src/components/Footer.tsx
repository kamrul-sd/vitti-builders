      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <div className="flex items-center space-x-2 text-xs text-emerald-500/80 bg-emerald-950/20 border border-emerald-900/30 px-3 py-1.5 rounded-full w-fit">
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs text-slate-500 leading-relaxed">
              <li className="flex items-start">
                <Building className="h-4 w-4 mr-2 text-slate-400 shrink-0 mt-0.5" />
                <span>
                  <strong>Vitti Builders Limited</strong><br />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@vittibuilders.com" className="hover:text-emerald-400 transition-colors">
